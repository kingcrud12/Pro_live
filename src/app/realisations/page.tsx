...
export default function RealisationsPage() {
  ...
  return (
    <div className="bg-surface text-on-surface font-body-md overflow-x-hidden w-full">
      {/* Page Header */}
      <header className="pt-24 pb-16 px-6 md:px-16 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 w-full">
          <div className="w-full lg:w-auto flex-1 max-w-3xl min-w-0">
            ...
            <h1 className="font-display-lg text-5xl sm:text-6xl md:text-[76px] uppercase leading-none mb-6 tracking-tight">
          ...
          <div className="flex flex-wrap gap-4 pt-2 lg:pt-0 shrink-0">
            {filterTabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`text-label-bold font-label-bold px-4 py-2 transition-all cursor-pointer text-sm tracking-wider uppercase ${active
      ...
      <main className="px-6 md:px-16 pb-24 max-w-7xl mx-auto">
      ...
      <section className="bg-on-surface text-surface py-24 px-6 md:px-16 overflow-hidden relative">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl sm:text-5xl md:text-display-lg font-display-lg uppercase mb-6 leading-tight tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link
              href="/contact"
              className="bg-primary text-on-primary px-8 py-4 font-label-bold text-label-bold hover:bg-primary-container transition-all tracking-widest inline-block uppercase shadow-lg"
            >
              Démarrer mon projet
            </Link>
            <Link
              href="/services"
              className="border-2 border-surface text-surface px-8 py-4 font-label-bold text-label-bold hover:bg-surface hover:text-on-surface transition-all tracking-widest inline-block uppercase"
            >
              Voir nos expertises
            </Link>
          </div>
